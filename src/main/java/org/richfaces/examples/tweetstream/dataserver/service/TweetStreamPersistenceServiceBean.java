...
public class TweetStreamPersistenceServiceBean implements TweetStreamPersistenceService
{
	...
	/**
	 * This is the most complex one, and uses ScoredTerm to simplify return value.
	 * I guess this is the most practical way to make a tag cloud out of all indexed terms.
	 * 
